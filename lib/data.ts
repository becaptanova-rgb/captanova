...
/**
 * Site-wide external links.
 *
 * ⚠️ AMAZON_KDP_URL is a PLACEHOLDER. Once "The Awareness Journal" is live
 * on Amazon KDP, replace this with the real product page URL, e.g.
 * "https://www.amazon.in/dp/XXXXXXXXXX"
 */
export const AMAZON_KDP_URL =
  "https://www.amazon.in/s?k=the+awareness+journal+captanova+academy";

/**
 * ⚠️ MASTERCLASS_DATE_ISO is a PLACEHOLDER.
 * Set this to the real date/time of the next live "Stop Overthinking, Start
 * Living" masterclass. Must be a full ISO 8601 string WITH timezone offset
