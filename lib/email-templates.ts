...
export function getMasterclassConfirmationHTML(name: string): string {
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>You're registered for the Free Masterclass</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: Georgia, serif; background: #0a0a0a; color: #fff; }
    .container { max-width: 600px; margin: 0 auto; padding: 40px 20px; }
    ...
    .card h2 { font-size: 30px; color: #ffffff; margin-bottom: 12px; }
    .card p { font-size: 16px; color: #ccc; line-height: 1.7; }
    .detail-box { background: #111; border: 1px solid #333; border-radius: 12px; padding: 24px; margin: 24px 0; }
    .detail-row { display: flex; justify-content: space-between; padding: 10px 0; border-bottom: 1px solid #222; font-size: 14px; color: #aaa; }
    .detail-row:last-child { border-bottom: none; color: #D4AF37; font-weight: bold; }
    .section { margin-bottom: 28px; }
    .section h4 { font-size: 11px; letter-spacing: 3px; text-transform: uppercase; color: #D4AF37; margin-bottom: 12px; }
    .section p { font-size: 15px; color: #ccc; line-height: 1.8; }
    .cta-button { display: block; background: linear-gradient(135deg, #D4AF37, #F0D060); color: #0a0a0a; text-align: center; padding: 18px 40px; border-radius: 8px; font-size: 16px; font-weight: 700; letter-spacing: 1px; text-decoration: none; margin: 24px 0; }
    .footer { text-align: center; padding-top: 32px; border-top: 1px solid #222; }
    .footer p { font-size: 13px; color: #555; line-height: 2; }
    .footer a { color: #D4AF37; text-decoration: none; }
  </style>
...
<body>
  <div class="container">
    ...
    <div class="card">
      <div class="badge">✅</div>
      <h2>You're In, ${name}!</h2>
      <p>Your seat for the free live masterclass — <strong style="color:#D4AF37">How To Stop Overthinking And Start Living</strong> — is confirmed.</p>
    </div>

    <div class="detail-box">
      <div class="detail-row"><span>Date</span><span>${dateLabel}</span></div>
      <div class="detail-row"><span>Time</span><span>${timeLabel} IST</span></div>
      <div class="detail-row"><span>Format</span><span>Live Online</span></div>
      <div class="detail-row"><span>Status</span><span>Confirmed ✓</span></div>
    </div>

    <div class="section">
      <h4>Before You Go</h4>
      <p>Add this to your calendar now so you don't miss it — the download link is on your confirmation page. We'll also send you a reminder and the live join link closer to the date.</p>
    </div>

    <a href="${process.env.NEXT_PUBLIC_SITE_URL}/masterclass" class="cta-button">
      View Masterclass Details →
    </a>

    <div class="section">
      <h4>What To Expect</h4>
      <p>In this session, Renu Sharma will walk you through the exact framework used inside Captanova to move from overthinking to clarity, and from clarity into consistent action — live, with time for your questions.</p>
    </div>
    ...
    <div class="footer">
      ...
      <p>The Academy for Mindset, Communication &amp; Self-Leadership</p>
      <p style="margin-top: 16px;"><a href="${process.env.NEXT_PUBLIC_SITE_URL}">captanovaacademy.com</a></p>
      <p style="margin-top: 24px; font-size: 11px; color: #444;">You received this because you registered for the Captanova free masterclass.<br>© 2026 Captanova Academy. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
